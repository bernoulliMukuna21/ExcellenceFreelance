            ...
            BookingModel.findOne({bookingID: acceptData.bookingToAcceptID})
                .then(bookingDetailUpdate =>{
                    ...
                    let bookingAcceptanceMessageToClientHTML = '<h1 style="color: #213e53; font-size: 1.1rem">Booking Accepted</h1>'+
                        ...
                        'href='+ kingsHireLoginURL +'> login </a> to your account to make the payment</p>'+
                    ...
                    bookingDetailUpdate.save(err => {
                        ...
                        mailer.smtpTransport.sendMail(mailer.mailerFunction('kingshire.team@gmail.com',
            ...
            BookingModel.findOne({bookingID: finishData.bookingFinishID})
                .then(bookingDetailUpdate =>{
                    ...
                    let completionRequestMessageToFreelancerHTML = '<h1 style="color: #213e53; font-size: 1.1rem">Booking Completed</h1>'+
                        ...
                        'cursor: pointer" href='+ kingsHireLoginURL +'> login </a> regularly to your account for updates.</p>'+
                        '<p>Thank you,<br>The KingsHire Team <br>07448804768</p>';
                    ...
                    let completionRequestMessageToClientHTML = '<h1 style="color: #213e53; font-size: 1.1rem">Booking Completed</h1>'+
                        ...
                        'color: #0645AD; cursor: pointer" '+ 'href='+ kingsHireLoginURL +'>'+
            ...
            try {
                ...
                if (allowedToSaveBooking) {
                    ...
                    let newBookingMessageToClientHTML = '<h1 style="color: #213e53; font-size: 1.1rem">New Booking</h1>' +
                        ...
                        ' cursor: pointer" href='+kingsHireLoginURL+'> login </a> regulary to check for updates' +
        ...
        BookingModel.findOne({bookingID: bookingID})
            .then(bookingDetailUpdate => {
                ...
                let bookingModificationToClientHTML = '<h1 style="color: #213e53; font-size: 1.1rem">Booking Modification</h1>'+
                    ...
                    ' cursor: pointer" href='+kingsHireLoginURL+'> login </a> to your account to accept or ' +
